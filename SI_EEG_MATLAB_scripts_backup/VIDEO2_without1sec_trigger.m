...
[d p] = playmovie(moviename_all{block_perm(2)}, num2str(par.CD_START), num2str(par.CD_END),sock)
...
% [success, ivx]=iViewX('datafile', ivx, ['C:\PsychToolbox_Experiments\Simon\AA_eyetracker_data\' subj_ID{1,1} '_Video2'  '.idf']);
% 
