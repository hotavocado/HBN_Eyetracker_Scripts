...
if par.useEL == 1 && par.useDrift == 0,  eyetr_sendtrigger(par.CD_START,sock); end;
window = Screen('OpenWindow', whichScreen, BGcolor);  
...
%                             [success, ivx]=iViewX('datafile', ivx, ['C:\PsychToolbox_Experiments\Simon\AA_eyetracker_data\' subj_ID{1,1} '_WISC_ProcSpeed'  '.idf']);
% 
