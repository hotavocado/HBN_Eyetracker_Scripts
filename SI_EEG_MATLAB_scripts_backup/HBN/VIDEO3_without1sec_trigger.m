...
[d p] = playmovie(moviename_all{block_perm(3)}, num2str(par.CD_START), num2str(par.CD_END), ivx, i)
...
[success, ivx]=iViewX('datafile', ivx, ['C:\PsychToolbox_Experiments\Simon\HBN\AA_eyetracker_data\' subj_ID{1,1} '_Video3'  '.idf']);
