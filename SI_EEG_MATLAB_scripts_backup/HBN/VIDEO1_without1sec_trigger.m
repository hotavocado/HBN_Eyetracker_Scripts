...
moviename_select = {moviename1(41:end); moviename3(41:end); moviename6(41:end)};
moviename_all = {moviename1; moviename3; moviename6};
...
save([par.runID , '_movie_order'],'block_perm','exclude','ind_fractals','movie_presentation_order', 'moviename_all','moviename_select','par')    
...
[d p] = playmovie(moviename_all{block_perm(1)}, num2str(par.CD_START), num2str(par.CD_END), ivx, i)
...
[success, ivx]=iViewX('datafile', ivx, ['C:\PsychToolbox_Experiments\Simon\HBN\AA_eyetracker_data\' subj_ID{1,1} '_Video1'  '.idf']);
