...
clc
disp('DID THE EEG STARTED RECORDING DATA? IF NOT, PRESS THE RECORD BUTTON!')
WaitSecs(3);
            ...
            if par.useEL
                if par.eyeFBK
                    ...
                    if isnan(x) & isnan(y) % blink
                        ...
                        if par.useEL, eyetr_sendtrigger(par.CD_BEEP,sock);end;
...
% [success, ivx]=iViewX('datafile', ivx, ['C:\PsychToolbox_Experiments\Simon\AA_eyetracker_data\' subj_ID{1,1} '_SAIIT_2AFC_Block1'  '.idf']);
% 
