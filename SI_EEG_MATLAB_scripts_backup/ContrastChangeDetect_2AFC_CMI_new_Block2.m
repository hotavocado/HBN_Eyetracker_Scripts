...
hands_file_path = '/home/eeg/PsychToolbox_Experiments/Simon/general_matlabfiles/';
...
if par.useEL, eyetr_sendtrigger(par.CD_RESP,sock);end;
...
feedback_file_path = '/home/eeg/PsychToolbox_Experiments/Simon/general_matlabfiles/';
...
% %% Sound Stuff
% 
% wavfilename_probe1 = '/home/eeg/PsychToolbox_Experiments/Simon/general_matlabfiles/prompt1_new.wav'
% wavfilename_probe2 = '/home/eeg/PsychToolbox_Experiments/Simon/general_matlabfiles/prompt2_new.wav'
            ...
            if m==1 & s==1
                ...
                %if par.useEL, calllib('iViewXAPI', 'iV_SendImageMessage', formatString(256, int8([ num2str(num2str(par.CD_TGOFF))])));end;
                 % if par.useEL, [success, ivx]=iViewX('message', ivx, [ num2str(num2str(par.CD_TGOFF))]);end;
                   if par.useEL, eyetr_sendtrigger(par.CD_TGOFF,sock);end; 
        ...
        if s==1
            ...
            %if par.useEL, calllib('iViewXAPI', 'iV_SendImageMessage', formatString(256, int8([ num2str(num2str(par.CD_TG(trialLR(n))))])));end;
             % if par.useEL, [success, ivx]=iViewX('message', ivx, [ num2str(num2str(par.CD_TG(trialLR(n))))]);end;
                if par.useEL, eyetr_sendtrigger(par.CD_TG(trialLR(n)),sock);end;
...
Screen('DrawText', window, 'Awesome!', 0.35*scresw, 0.55*scresh, 255);
Screen('Flip', window);  
WaitSecs(3)
...
% [success, ivx]=iViewX('datafile', ivx, ['C:\PsychToolbox_Experiments\Simon\AA_eyetracker_data\' subj_ID{1,1} '_SAIIT_2AFC_Block2'  '.idf']);
% 
...
save([par.runID , '_SAIIT_2AFC_Block2'],'ITIstartT','TargOnT','RespT','RespLR','trialITI','trialLR','par') 
close all
